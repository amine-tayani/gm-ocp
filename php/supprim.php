...
<td> <?php echo '<a href="supprimer.php?var='.$donnees['num_feuille'].'&debut='.$donnees['debut'].'&fin='.$donnees['fin'].'&bil='.$donnees['bilan'].'&mat='.$donnees['matricule'].'" style="color:#3498db;text-decoration:unset;">Supprimer</a>'; ?> </td>
